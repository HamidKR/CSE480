...
| Week 2 | Filters, Constraints and Joins (HW#3, HW#4). <br /> Update, Delete, Union, Dates and Times, <br /> Foreign Keys, and Checks (HW#4). <br /> Triggers, Views, Indices, Stored Procedures, <br />CASE, Functions, Aggregates, Collations, <br />Adapters and Converters (HW#5). | HW#2 due Wed. (05-22). <br /> HW#3 due Sat. (05-25).<br /> HW#4 released (05-22). <br /> HW#5 released (05-25). <br /> HW#4 due Wed. (05-29). |
| Week 3 | Transations and Schedules (HW#6). <br /> Locks and Rollbacks (HW#7). | HW#6 released (05-29). <br /> HW#7 released (06-01). <br /> HW#5 due Sat. (06-01). <br /> HW#6 due Wed. (06-05). | 
| Week 4 | Optimistic Scheduling (HW#8). <br /> Entity-Relationship Diagrams (HW#9). | HW#7 due Sat. (06-08). <br /> HW#8 released (06-05).<br /> HW#8 due Wed. (06-12). <br /> HW#9 released (06-08) | 
