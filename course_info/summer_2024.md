...
| Week 2 | Filters, Constraints and Joins (HW#3, HW#4). <br /> Update, Delete, Union, Dates and Times, <br /> Foreign Keys, and Checks (HW#4). <br /> Triggers, Views, Indices, Stored Procedures, <br />CASE, Functions, Aggregates, Collations, <br />Adapters and Converters (HW#5). | HW#2 due Wed. (05-22). <br /> HW#3 due Sat. (05-25).<br /> HW#4 released (05-22). <br /> HW#4 due Wed. (05-29).<br /> HW#5 released (05-25). |
