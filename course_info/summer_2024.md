...
Course materials are available in [D2L](https://d2l.msu.edu/) under `Content`. New lecture notes will be released early on Monday. Release dates and due dates of HWs are shown below with the release time at 12:00AM and the due time at 10:00PM. $${\color{red} All the times in the syllabus use Eastern Time Zone}$$.
