...
| ----       | ------- |  ----- | 
| Week 1 | Course Overview <br /> Schemas  and File Formats (HW#1)<br /> Basic SQL (Create, Insert, Select) (HW#2, HW#3). <br /> Filters, Constraints and Joins (HW#3, HW#4).  | HW#0 due Wed. (05-15). <br /> HW#0 not worth any points. <br /> HW#1 released (05-13). <br /> HW#1 due Sat. (05-25).<br /> HW#2 released (05-15). <br /> HW#3 released (05-15).|
| Week 2 | Update, Delete, Union, Dates and Times, <br /> Foreign Keys, and Checks (HW#4). <br /> Triggers, Views, Indices, Stored Procedures, <br />CASE, Functions, Aggregates, Collations, <br />Adapters and Converters (HW#5). | HW#2 due Sat. (05-25). <br /> HW#3 due Sat. (05-25).<br /> HW#4 released (05-22). <br /> HW#5 released (05-25). |
