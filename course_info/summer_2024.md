...
| ----       | ------- |  ----- | 
| Week 1 | Course Overview <br /> Schemas  and File Formats (HW#1)<br /> Basic SQL (Create, Insert, Select) (HW#2, HW#3) | HW#0 due Wed. (05-15). <br /> HW#0 not worth any points. <br /> HW#1 released (05-013). <br /> HW#1 due Sat. (05-18).<br /> HW#2 released (05-15). |
